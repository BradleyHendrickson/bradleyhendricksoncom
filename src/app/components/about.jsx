        ...
        <div className="max-w-4xl mx-auto px-4 py-12 bg-white">
            <div className="grid grid-cols-1 md:grid-cols-12 md:gap-16">
                ...
                <div className="md:col-span-7 mb-12 md:mb-0">
                    <h2 className="text-4xl font-bold mb-2 tracking-tight uppercase inline-block pb-1">
                        About Me
                    </h2>
                    <p className="text-base text-gray-700 mt-6 mb-1 font-semibold tracking-wide uppercase">
                        Full-Stack Developer
                    </p>
                    <p className="text-base text-gray-700 mb-6 font-semibold tracking-wide uppercase">
                ...
                <div className="md:col-span-5 space-y-10">
                    <div>
                        <h2 className="text-xl font-bold mb-1 tracking-tight uppercase inline-block pb-1">
                            Contact
                        </h2>
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-3">
                            {[
                                ...
                                <span
                                    key={skill}
                                    className="inline-block uppercase bg-blue-100 border border-black rounded-sm text-black text-xs px-3 py-1 font-semibold tracking-wider"
                                >
                                    {skill}
                                </span>
                            ))}
